                    ...
                    <div className='bg-muted/30 sticky top-0 z-10 flex border-b'>
                        ...
                        <div className='flex flex-1'>
                            {Array.from({ length: timeSlotCount }).map((_, i) => (
                                <div
                                    key={i}
                                    className='relative shrink-0 border-r border-border px-2 py-3 md:py-4 w-[60px] md:w-[80px] flex items-center justify-center'
                                >
                    ...
                    <div className='divide-y'>
                        {Array.from({ length: skeletonRows }).map((_, rowIndex) => (
                            <div key={rowIndex} className='flex border-b last:border-b-0'>
                                {/* Court label */}
                                <div className='w-32 shrink-0 border-r px-4 py-5 md:w-40 md:py-6 flex items-center'>
